...
-- Corriger les relations dans la table planning
-- Assurer que la table planning existe avec les bonnes colonnes
-- Assurer que les colonnes ID sont bien en UUID
...
DROP POLICY IF EXISTS "Authenticated users can manage planning" ON planning;
